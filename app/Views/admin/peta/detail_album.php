...
<div class="col-12">
    <div class="card">
        ...
        <?= form_open_multipart('simpan_album_peta'); ?>
        <div class="card-body">
            <input type="hidden" name="id_pariwisata" value="<?= $wisata->id_pariwisata ?>">
    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            <div class="row">
                ...
                ?>
                        <div class="col-sm-2" data-category="<?= $a->id_pariwisata ?>">
                            <a href="<?= base_url() ?>/images/album/<?= $a->gambar ?>" data-toggle="lightbox" data-title="<?= $a->nama ?>" data-gallery="gallery">
                                <img src="<?= base_url() ?>/images/album/<?= $a->gambar ?>" class="img-fluid mb-2" alt="white sample" />
                            </a>
                            <a href="<?= base_url('hapus_album_peta/' . $a->id) ?>" class="text-black"><i class="fa fa-trash"></i></a>
                        </div>
                <?php }
                } ?>
            </div>
            <a class="btn btn-sm btn-info" href="<?= base_url('all_album_peta') ?>"><i class="ti-arrow-left"></i> Kembali</a>
        </div>
    </div>
</div>
