                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('detail_album_acara/' . $value->id_acara); ?>" class="btn btn-success btn-sm">Detail</a>
                            </td>
                        </tr>
                    <?php
                    }
    ...
    <div class="card-body">
        <div>
            <div class="btn-group w-100 mb-2">
                ...
                <?php foreach ($acara as $p) { ?>
                    <a class="btn btn-info text-capitalize" href="javascript:void(0)" data-filter="<?= $p->id_acara ?>"><?= substr($p->nama_tempat, 0, 10) ?> </a>
                <?php } ?>
            </div>
        ...
        <div>
            <div class="filter-container p-0 row">
                ...
                ?>
                        <div class="filtr-item col-sm-2" data-category="<?= $a->id_acara ?>">
                            <a href="<?= base_url() ?>/acara/album/<?= $a->gambar ?>" data-toggle="lightbox" data-title="<?= $a->nama ?>">
